    ...
    public class Startup
    {
        ...
        public static void Configure(IApplicationBuilder app, IWebHostEnvironment env, IConfiguration config)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                {
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Testt API v1");
        ...
        public void ConfigureContainer(IUnityContainer container)
        {
            ...
            TesttCurrentUserService currentUserService = new (container.Resolve<IHttpContextAccessor>(), container.Resolve<IDataService>());

            container.RegisterInstance<ITesttCurrentUserService>(currentUserService);
