namespace Testt.WebAPI.Controllers
{
    ...
    public class UserSettingsController : ControllerBase
    {
        ...
        /// </summary>
        private readonly ITesttCurrentUserService _currentUserService;
        ...
        public UserSettingsController(IUserSettingsService userSettingsService, ITesttCurrentUserService currentUserService)
        {
