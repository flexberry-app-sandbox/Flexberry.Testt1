namespace Testt.ApplicationLayer.Services
{
    ...
    /// </summary>
    public class TesttCurrentUserService : ITesttCurrentUserService
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TesttCurrentUserService"/> class.
        /// </summary>
        /// <param name="httpContextAccessor">Доступ к текущему контексту.</param>
        /// <param name="dataService">Сервис для вычитки данных.</param>
        public TesttCurrentUserService(IHttpContextAccessor httpContextAccessor, IDataService dataService)
        {
